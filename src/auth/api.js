...
export const api = {
  ...
  socialAnalyticsExportUrl: () => '/api/social/analytics/export',
  ...
  socialBrandVoice:    () => fetchJson('/api/social/brand-voice'),
  socialSetBrandVoice: (brandVoice) => fetchJson('/api/social/brand-voice', { method: 'PUT', body: { brandVoice } }),
  ...
  brief:           (viewAs) => fetchJson(`/api/brief${viewAs ? `?viewAs=${encodeURIComponent(viewAs)}` : ''}`),
